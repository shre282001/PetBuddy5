...
class aquaticCard extends StatefulWidget {
  @override
  State<aquaticCard> createState() => _aquaticCardState();
}

class _aquaticCardState extends State<aquaticCard> {
  final List<Product> products = [];

  void getData() async {
    var snapshot = await FirebaseFirestore.instance.collection('Pets').where('type', isEqualTo: 'Fish').get();
    ...
    for (var doc in documents) {
      ...
      newProducts.add(Product(name: name, description: description, imagePath: imagePath));
    }
